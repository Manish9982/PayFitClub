...
const CyclingDuration = ({ navigation, route }) => {
    ...
    const onPressNext = () => {
        if (days == '') {
            ...
            navigation.navigate('DistanceCycling', {
    ...
    return (
        <View style={styles.container}>
            ...
            <TextInputMed
                ...
                label={`Select ${route?.params?.duration}s For Cycling`}
...
export default CyclingDuration
