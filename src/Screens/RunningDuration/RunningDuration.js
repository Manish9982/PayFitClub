...
const RunningDuration = ({ navigation, route }) => {
    ...
    const onPressNext = () => {
        if (days == '') {
            ...
            navigation.navigate('DistanceRunning', {
        ...
        <KeyboardAwareScrollView>
            <View style={styles.container}>
                ...
                <TextInputMed
                    ...
                    label={`Select ${route?.params?.duration}s For Running`}
...
export default RunningDuration
